...
#### cURL
```bash
curl -X POST https://api.cursiveletters.in/api/products/update-inventory \
...
const response = await fetch('https://api.cursiveletters.in/api/products/update-inventory', {
    method: 'POST',
    headers: {
